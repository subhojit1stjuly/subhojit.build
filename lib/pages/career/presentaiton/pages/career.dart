...
import 'package:subhojit_build/pages/career/presentaiton/components/academic_section.dart';
import 'package:subhojit_build/pages/career/presentaiton/components/career_hero.dart';
import 'package:subhojit_build/pages/career/presentaiton/components/competencies_section.dart';
import 'package:subhojit_build/pages/career/presentaiton/controller/career_page_controller.dart';
...
class CareerPage extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    final CareerPageController notifier = getIt<CareerPageController>();

    return ValueBuilder<CareerPageState>(
      valueNotifier: notifier,
      builder: (context, state) {
        return Component.fragment([
          const CareerHero(),
          CareerSection(jobs: state.jobs),
          AcademicSection(certificates: state.certifications),
