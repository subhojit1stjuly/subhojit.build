...
import 'package:subhojit_build/pages/project/presentation/controller/project_page_controller.dart';
...
class ProjectsPage extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    final ProjectPageController notifier = getIt<ProjectPageController>();
    ...
    return section(classes: 'projects-page', [
      div(classes: 'projects-page-inner container', [
        ...
        // Two-column layout: Main Content (Projects) + Sidebar (Stats)
            ...
            builder: (context, state) {
              return div(classes: 'projects-main', [
                ...
                div(classes: 'projects-grid', [
                  for (final p in state.currentProjects)
                    PostCard(
                      data: InfoCardModel(
                        title: p.title,
