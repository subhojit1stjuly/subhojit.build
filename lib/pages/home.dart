  ...
  Component build(BuildContext context) {
    ...
    final projects = [
      Project(
        ...
        description: 'Production app with real-time inventory, smooth 60fps transitions, and a custom parallax product hero. Serves 200k+ monthly active users.',
      ...
      Project(
        ...
        description: 'Developer-productivity CLI automating code-generation, asset optimisation, and release tagging for Flutter mono-repos. Used internally by 3 product teams.',
      ...
      Project(
        ...
        description: 'Opinionated reference implementation comparing Riverpod, Bloc, and Provider across identical feature slices. Onboarding resource for new engineers.',
